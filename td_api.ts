...
namespace TdApi {
    ...
    type td_Error = td_error;
    type td_Ok = td_ok;
    type td_TdlibParameters = td_tdlibParameters;
    type td_AuthenticationCodeType = td_authenticationCodeTypeTelegramMessage | td_authenticationCodeTypeSms | td_authenticationCodeTypeCall | td_authenticationCodeTypeFlashCall;
    type td_AuthenticationCodeInfo = td_authenticationCodeInfo;
    type td_EmailAddressAuthenticationCodeInfo = td_emailAddressAuthenticationCodeInfo;
    type td_TextEntity = td_textEntity;
    type td_TextEntities = td_textEntities;
    type td_FormattedText = td_formattedText;
    type td_TermsOfService = td_termsOfService;
    type td_AuthorizationState = td_authorizationStateWaitTdlibParameters | td_authorizationStateWaitEncryptionKey | td_authorizationStateWaitPhoneNumber | td_authorizationStateWaitCode | td_authorizationStateWaitOtherDeviceConfirmation | td_authorizationStateWaitRegistration | td_authorizationStateWaitPassword | td_authorizationStateReady | td_authorizationStateLoggingOut | td_authorizationStateClosing | td_authorizationStateClosed;
    type td_PasswordState = td_passwordState;
    type td_RecoveryEmailAddress = td_recoveryEmailAddress;
    type td_TemporaryPasswordState = td_temporaryPasswordState;
    type td_LocalFile = td_localFile;
    type td_RemoteFile = td_remoteFile;
    type td_File = td_file;
    type td_InputFile = td_inputFileId | td_inputFileRemote | td_inputFileLocal | td_inputFileGenerated;
    type td_PhotoSize = td_photoSize;
    type td_Minithumbnail = td_minithumbnail;
    type td_ThumbnailFormat = td_thumbnailFormatJpeg | td_thumbnailFormatPng | td_thumbnailFormatWebp | td_thumbnailFormatGif | td_thumbnailFormatTgs | td_thumbnailFormatMpeg4;
    type td_Thumbnail = td_thumbnail;
    type td_MaskPoint = td_maskPointForehead | td_maskPointEyes | td_maskPointMouth | td_maskPointChin;
    type td_MaskPosition = td_maskPosition;
    type td_ClosedVectorPath = td_closedVectorPath;
    type td_PollOption = td_pollOption;
    type td_PollType = td_pollTypeRegular | td_pollTypeQuiz;
    type td_Animation = td_animation;
    type td_Audio = td_audio;
    type td_Document = td_document;
    type td_Photo = td_photo;
    type td_Sticker = td_sticker;
    type td_Video = td_video;
    type td_VideoNote = td_videoNote;
    type td_VoiceNote = td_voiceNote;
    type td_Contact = td_contact;
    type td_Location = td_location;
    type td_Venue = td_venue;
    type td_Game = td_game;
    type td_Poll = td_poll;
    type td_ProfilePhoto = td_profilePhoto;
    type td_ChatPhotoInfo = td_chatPhotoInfo;
    type td_UserType = td_userTypeRegular | td_userTypeDeleted | td_userTypeBot | td_userTypeUnknown;
    type td_BotCommand = td_botCommand;
    type td_BotCommands = td_botCommands;
    type td_ChatLocation = td_chatLocation;
    type td_AnimatedChatPhoto = td_animatedChatPhoto;
    type td_ChatPhoto = td_chatPhoto;
    type td_ChatPhotos = td_chatPhotos;
    type td_InputChatPhoto = td_inputChatPhotoPrevious | td_inputChatPhotoStatic | td_inputChatPhotoAnimation;
    type td_User = td_user;
    type td_UserFullInfo = td_userFullInfo;
    type td_Users = td_users;
    type td_ChatAdministrator = td_chatAdministrator;
    type td_ChatAdministrators = td_chatAdministrators;
    type td_ChatPermissions = td_chatPermissions;
    type td_ChatMemberStatus = td_chatMemberStatusCreator | td_chatMemberStatusAdministrator | td_chatMemberStatusMember | td_chatMemberStatusRestricted | td_chatMemberStatusLeft | td_chatMemberStatusBanned;
    type td_ChatMember = td_chatMember;
    type td_ChatMembers = td_chatMembers;
    type td_ChatMembersFilter = td_chatMembersFilterContacts | td_chatMembersFilterAdministrators | td_chatMembersFilterMembers | td_chatMembersFilterMention | td_chatMembersFilterRestricted | td_chatMembersFilterBanned | td_chatMembersFilterBots;
    type td_SupergroupMembersFilter = td_supergroupMembersFilterRecent | td_supergroupMembersFilterContacts | td_supergroupMembersFilterAdministrators | td_supergroupMembersFilterSearch | td_supergroupMembersFilterRestricted | td_supergroupMembersFilterBanned | td_supergroupMembersFilterMention | td_supergroupMembersFilterBots;
    type td_ChatInviteLink = td_chatInviteLink;
    type td_ChatInviteLinks = td_chatInviteLinks;
    type td_ChatInviteLinkCount = td_chatInviteLinkCount;
    type td_ChatInviteLinkCounts = td_chatInviteLinkCounts;
    type td_ChatInviteLinkMember = td_chatInviteLinkMember;
    type td_ChatInviteLinkMembers = td_chatInviteLinkMembers;
    type td_ChatInviteLinkInfo = td_chatInviteLinkInfo;
    type td_BasicGroup = td_basicGroup;
    type td_BasicGroupFullInfo = td_basicGroupFullInfo;
    type td_Supergroup = td_supergroup;
    type td_SupergroupFullInfo = td_supergroupFullInfo;
    type td_SecretChatState = td_secretChatStatePending | td_secretChatStateReady | td_secretChatStateClosed;
    type td_SecretChat = td_secretChat;
    type td_MessageSender = td_messageSenderUser | td_messageSenderChat;
    type td_MessageSenders = td_messageSenders;
    type td_MessageForwardOrigin = td_messageForwardOriginUser | td_messageForwardOriginChat | td_messageForwardOriginHiddenUser | td_messageForwardOriginChannel | td_messageForwardOriginMessageImport;
    type td_MessageForwardInfo = td_messageForwardInfo;
    type td_MessageReplyInfo = td_messageReplyInfo;
    type td_MessageInteractionInfo = td_messageInteractionInfo;
    type td_MessageSendingState = td_messageSendingStatePending | td_messageSendingStateFailed;
    type td_Message = td_message;
    type td_Messages = td_messages;
    type td_FoundMessages = td_foundMessages;
    type td_SponsoredMessage = td_sponsoredMessage;
    type td_SponsoredMessages = td_sponsoredMessages;
    type td_NotificationSettingsScope = td_notificationSettingsScopePrivateChats | td_notificationSettingsScopeGroupChats | td_notificationSettingsScopeChannelChats;
    type td_ChatNotificationSettings = td_chatNotificationSettings;
    type td_ScopeNotificationSettings = td_scopeNotificationSettings;
    type td_DraftMessage = td_draftMessage;
    type td_ChatType = td_chatTypePrivate | td_chatTypeBasicGroup | td_chatTypeSupergroup | td_chatTypeSecret;
    type td_ChatFilter = td_chatFilter;
    type td_ChatFilterInfo = td_chatFilterInfo;
    type td_RecommendedChatFilter = td_recommendedChatFilter;
    type td_RecommendedChatFilters = td_recommendedChatFilters;
    type td_ChatList = td_chatListMain | td_chatListArchive | td_chatListFilter;
    type td_ChatLists = td_chatLists;
    type td_ChatSource = td_chatSourceMtprotoProxy | td_chatSourcePublicServiceAnnouncement;
    type td_ChatPosition = td_chatPosition;
    type td_VoiceChat = td_voiceChat;
    type td_Chat = td_chat;
    type td_Chats = td_chats;
    type td_ChatNearby = td_chatNearby;
    type td_ChatsNearby = td_chatsNearby;
    type td_PublicChatType = td_publicChatTypeHasUsername | td_publicChatTypeIsLocationBased;
    type td_ChatActionBar = td_chatActionBarReportSpam | td_chatActionBarReportUnrelatedLocation | td_chatActionBarInviteMembers | td_chatActionBarReportAddBlock | td_chatActionBarAddContact | td_chatActionBarSharePhoneNumber;
    type td_KeyboardButtonType = td_keyboardButtonTypeText | td_keyboardButtonTypeRequestPhoneNumber | td_keyboardButtonTypeRequestLocation | td_keyboardButtonTypeRequestPoll;
    type td_KeyboardButton = td_keyboardButton;
    type td_InlineKeyboardButtonType = td_inlineKeyboardButtonTypeUrl | td_inlineKeyboardButtonTypeLoginUrl | td_inlineKeyboardButtonTypeCallback | td_inlineKeyboardButtonTypeCallbackWithPassword | td_inlineKeyboardButtonTypeCallbackGame | td_inlineKeyboardButtonTypeSwitchInline | td_inlineKeyboardButtonTypeBuy;
    type td_InlineKeyboardButton = td_inlineKeyboardButton;
    type td_ReplyMarkup = td_replyMarkupRemoveKeyboard | td_replyMarkupForceReply | td_replyMarkupShowKeyboard | td_replyMarkupInlineKeyboard;
    type td_LoginUrlInfo = td_loginUrlInfoOpen | td_loginUrlInfoRequestConfirmation;
    type td_MessageThreadInfo = td_messageThreadInfo;
    type td_RichText = td_richTextPlain | td_richTextBold | td_richTextItalic | td_richTextUnderline | td_richTextStrikethrough | td_richTextFixed | td_richTextUrl | td_richTextEmailAddress | td_richTextSubscript | td_richTextSuperscript | td_richTextMarked | td_richTextPhoneNumber | td_richTextIcon | td_richTextReference | td_richTextAnchor | td_richTextAnchorLink | td_richTexts;
    type td_PageBlockCaption = td_pageBlockCaption;
    type td_PageBlockListItem = td_pageBlockListItem;
    type td_PageBlockHorizontalAlignment = td_pageBlockHorizontalAlignmentLeft | td_pageBlockHorizontalAlignmentCenter | td_pageBlockHorizontalAlignmentRight;
    type td_PageBlockVerticalAlignment = td_pageBlockVerticalAlignmentTop | td_pageBlockVerticalAlignmentMiddle | td_pageBlockVerticalAlignmentBottom;
    type td_PageBlockTableCell = td_pageBlockTableCell;
    type td_PageBlockRelatedArticle = td_pageBlockRelatedArticle;
    type td_PageBlock = td_pageBlockTitle | td_pageBlockSubtitle | td_pageBlockAuthorDate | td_pageBlockHeader | td_pageBlockSubheader | td_pageBlockKicker | td_pageBlockParagraph | td_pageBlockPreformatted | td_pageBlockFooter | td_pageBlockDivider | td_pageBlockAnchor | td_pageBlockList | td_pageBlockBlockQuote | td_pageBlockPullQuote | td_pageBlockAnimation | td_pageBlockAudio | td_pageBlockPhoto | td_pageBlockVideo | td_pageBlockVoiceNote | td_pageBlockCover | td_pageBlockEmbedded | td_pageBlockEmbeddedPost | td_pageBlockCollage | td_pageBlockSlideshow | td_pageBlockChatLink | td_pageBlockTable | td_pageBlockDetails | td_pageBlockRelatedArticles | td_pageBlockMap;
    type td_WebPageInstantView = td_webPageInstantView;
    type td_WebPage = td_webPage;
    type td_CountryInfo = td_countryInfo;
    type td_Countries = td_countries;
    type td_PhoneNumberInfo = td_phoneNumberInfo;
    type td_BankCardActionOpenUrl = td_bankCardActionOpenUrl;
    type td_BankCardInfo = td_bankCardInfo;
    type td_Address = td_address;
    type td_LabeledPricePart = td_labeledPricePart;
    type td_Invoice = td_invoice;
    type td_OrderInfo = td_orderInfo;
    type td_ShippingOption = td_shippingOption;
    type td_SavedCredentials = td_savedCredentials;
    type td_InputCredentials = td_inputCredentialsSaved | td_inputCredentialsNew | td_inputCredentialsApplePay | td_inputCredentialsGooglePay;
    type td_PaymentsProviderStripe = td_paymentsProviderStripe;
    type td_PaymentFormTheme = td_paymentFormTheme;
    type td_PaymentForm = td_paymentForm;
    type td_ValidatedOrderInfo = td_validatedOrderInfo;
    type td_PaymentResult = td_paymentResult;
    type td_PaymentReceipt = td_paymentReceipt;
    type td_DatedFile = td_datedFile;
    ...
    type td_UserStatus = td_userStatusEmpty | td_userStatusOnline | td_userStatusOffline | td_userStatusRecently | td_userStatusLastWeek | td_userStatusLastMonth;
    type td_Stickers = td_stickers;
    type td_Emojis = td_emojis;
    type td_StickerSet = td_stickerSet;
    type td_StickerSetInfo = td_stickerSetInfo;
    type td_StickerSets = td_stickerSets;
    type td_CallDiscardReason = td_callDiscardReasonEmpty | td_callDiscardReasonMissed | td_callDiscardReasonDeclined | td_callDiscardReasonDisconnected | td_callDiscardReasonHungUp;
    type td_CallProtocol = td_callProtocol;
    type td_CallServerType = td_callServerTypeTelegramReflector | td_callServerTypeWebrtc;
    type td_CallServer = td_callServer;
    type td_CallId = td_callId;
    type td_GroupCallId = td_groupCallId;
    type td_CallState = td_callStatePending | td_callStateExchangingKeys | td_callStateReady | td_callStateHangingUp | td_callStateDiscarded | td_callStateError;
    type td_GroupCallVideoQuality = td_groupCallVideoQualityThumbnail | td_groupCallVideoQualityMedium | td_groupCallVideoQualityFull;
    type td_GroupCallRecentSpeaker = td_groupCallRecentSpeaker;
    type td_GroupCall = td_groupCall;
    type td_GroupCallVideoSourceGroup = td_groupCallVideoSourceGroup;
    type td_GroupCallParticipantVideoInfo = td_groupCallParticipantVideoInfo;
    type td_GroupCallParticipant = td_groupCallParticipant;
    type td_CallProblem = td_callProblemEcho | td_callProblemNoise | td_callProblemInterruptions | td_callProblemDistortedSpeech | td_callProblemSilentLocal | td_callProblemSilentRemote | td_callProblemDropped | td_callProblemDistortedVideo | td_callProblemPixelatedVideo;
    type td_Call = td_call;
    type td_PhoneNumberAuthenticationSettings = td_phoneNumberAuthenticationSettings;
    type td_Animations = td_animations;
    type td_DiceStickers = td_diceStickersRegular | td_diceStickersSlotMachine;
    type td_ImportedContacts = td_importedContacts;
    type td_HttpUrl = td_httpUrl;
    type td_InputInlineQueryResult = td_inputInlineQueryResultAnimation | td_inputInlineQueryResultArticle | td_inputInlineQueryResultAudio | td_inputInlineQueryResultContact | td_inputInlineQueryResultDocument | td_inputInlineQueryResultGame | td_inputInlineQueryResultLocation | td_inputInlineQueryResultPhoto | td_inputInlineQueryResultSticker | td_inputInlineQueryResultVenue | td_inputInlineQueryResultVideo | td_inputInlineQueryResultVoiceNote;
    type td_InlineQueryResult = td_inlineQueryResultArticle | td_inlineQueryResultContact | td_inlineQueryResultLocation | td_inlineQueryResultVenue | td_inlineQueryResultGame | td_inlineQueryResultAnimation | td_inlineQueryResultAudio | td_inlineQueryResultDocument | td_inlineQueryResultPhoto | td_inlineQueryResultSticker | td_inlineQueryResultVideo | td_inlineQueryResultVoiceNote;
    type td_InlineQueryResults = td_inlineQueryResults;
    type td_CallbackQueryPayload = td_callbackQueryPayloadData | td_callbackQueryPayloadDataWithPassword | td_callbackQueryPayloadGame;
    type td_CallbackQueryAnswer = td_callbackQueryAnswer;
    type td_CustomRequestResult = td_customRequestResult;
    type td_GameHighScore = td_gameHighScore;
    type td_GameHighScores = td_gameHighScores;
    type td_ChatEventAction = td_chatEventMessageEdited | td_chatEventMessageDeleted | td_chatEventPollStopped | td_chatEventMessagePinned | td_chatEventMessageUnpinned | td_chatEventMemberJoined | td_chatEventMemberJoinedByInviteLink | td_chatEventMemberLeft | td_chatEventMemberInvited | td_chatEventMemberPromoted | td_chatEventMemberRestricted | td_chatEventTitleChanged | td_chatEventPermissionsChanged | td_chatEventDescriptionChanged | td_chatEventUsernameChanged | td_chatEventPhotoChanged | td_chatEventInvitesToggled | td_chatEventLinkedChatChanged | td_chatEventSlowModeDelayChanged | td_chatEventMessageTtlSettingChanged | td_chatEventSignMessagesToggled | td_chatEventStickerSetChanged | td_chatEventLocationChanged | td_chatEventIsAllHistoryAvailableToggled | td_chatEventInviteLinkEdited | td_chatEventInviteLinkRevoked | td_chatEventInviteLinkDeleted | td_chatEventVoiceChatCreated | td_chatEventVoiceChatDiscarded | td_chatEventVoiceChatParticipantIsMutedToggled | td_chatEventVoiceChatParticipantVolumeLevelChanged | td_chatEventVoiceChatMuteNewParticipantsToggled;
    type td_ChatEvent = td_chatEvent;
    type td_ChatEvents = td_chatEvents;
    type td_ChatEventLogFilters = td_chatEventLogFilters;
    type td_LanguagePackStringValue = td_languagePackStringValueOrdinary | td_languagePackStringValuePluralized | td_languagePackStringValueDeleted;
    type td_LanguagePackString = td_languagePackString;
    type td_LanguagePackStrings = td_languagePackStrings;
    type td_LanguagePackInfo = td_languagePackInfo;
    type td_LocalizationTargetInfo = td_localizationTargetInfo;
    ...
    type td_PushReceiverId = td_pushReceiverId;
    type td_BackgroundFill = td_backgroundFillSolid | td_backgroundFillGradient | td_backgroundFillFreeformGradient;
    type td_BackgroundType = td_backgroundTypeWallpaper | td_backgroundTypePattern | td_backgroundTypeFill;
    type td_Background = td_background;
    type td_Backgrounds = td_backgrounds;
    type td_InputBackground = td_inputBackgroundLocal | td_inputBackgroundRemote;
    type td_ThemeSettings = td_themeSettings;
    type td_ChatTheme = td_chatTheme;
    type td_Hashtags = td_hashtags;
    type td_CanTransferOwnershipResult = td_canTransferOwnershipResultOk | td_canTransferOwnershipResultPasswordNeeded | td_canTransferOwnershipResultPasswordTooFresh | td_canTransferOwnershipResultSessionTooFresh;
    type td_CheckChatUsernameResult = td_checkChatUsernameResultOk | td_checkChatUsernameResultUsernameInvalid | td_checkChatUsernameResultUsernameOccupied | td_checkChatUsernameResultPublicChatsTooMuch | td_checkChatUsernameResultPublicGroupsUnavailable;
    type td_CheckStickerSetNameResult = td_checkStickerSetNameResultOk | td_checkStickerSetNameResultNameInvalid | td_checkStickerSetNameResultNameOccupied;
    type td_ResetPasswordResult = td_resetPasswordResultOk | td_resetPasswordResultPending | td_resetPasswordResultDeclined;
    type td_MessageFileType = td_messageFileTypePrivate | td_messageFileTypeGroup | td_messageFileTypeUnknown;
    type td_PushMessageContent = td_pushMessageContentHidden | td_pushMessageContentAnimation | td_pushMessageContentAudio | td_pushMessageContentContact | td_pushMessageContentContactRegistered | td_pushMessageContentDocument | td_pushMessageContentGame | td_pushMessageContentGameScore | td_pushMessageContentInvoice | td_pushMessageContentLocation | td_pushMessageContentPhoto | td_pushMessageContentPoll | td_pushMessageContentScreenshotTaken | td_pushMessageContentSticker | td_pushMessageContentText | td_pushMessageContentVideo | td_pushMessageContentVideoNote | td_pushMessageContentVoiceNote | td_pushMessageContentBasicGroupChatCreate | td_pushMessageContentChatAddMembers | td_pushMessageContentChatChangePhoto | td_pushMessageContentChatChangeTitle | td_pushMessageContentChatChangeTheme | td_pushMessageContentChatDeleteMember | td_pushMessageContentChatJoinByLink | td_pushMessageContentMessageForwards | td_pushMessageContentMediaAlbum;
    type td_NotificationType = td_notificationTypeNewMessage | td_notificationTypeNewSecretChat | td_notificationTypeNewCall | td_notificationTypeNewPushMessage;
    type td_NotificationGroupType = td_notificationGroupTypeMessages | td_notificationGroupTypeMentions | td_notificationGroupTypeSecretChat | td_notificationGroupTypeCalls;
    type td_Notification = td_notification;
    type td_NotificationGroup = td_notificationGroup;
    type td_OptionValue = td_optionValueBoolean | td_optionValueEmpty | td_optionValueInteger | td_optionValueString;
    type td_JsonObjectMember = td_jsonObjectMember;
    type td_JsonValue = td_jsonValueNull | td_jsonValueBoolean | td_jsonValueNumber | td_jsonValueString | td_jsonValueArray | td_jsonValueObject;
    type td_UserPrivacySettingRule = td_userPrivacySettingRuleAllowAll | td_userPrivacySettingRuleAllowContacts | td_userPrivacySettingRuleAllowUsers | td_userPrivacySettingRuleAllowChatMembers | td_userPrivacySettingRuleRestrictAll | td_userPrivacySettingRuleRestrictContacts | td_userPrivacySettingRuleRestrictUsers | td_userPrivacySettingRuleRestrictChatMembers;
    type td_UserPrivacySettingRules = td_userPrivacySettingRules;
    type td_UserPrivacySetting = td_userPrivacySettingShowStatus | td_userPrivacySettingShowProfilePhoto | td_userPrivacySettingShowLinkInForwardedMessages | td_userPrivacySettingShowPhoneNumber | td_userPrivacySettingAllowChatInvites | td_userPrivacySettingAllowCalls | td_userPrivacySettingAllowPeerToPeerCalls | td_userPrivacySettingAllowFindingByPhoneNumber;
    type td_AccountTtl = td_accountTtl;
    type td_Session = td_session;
    type td_Sessions = td_sessions;
    type td_ConnectedWebsite = td_connectedWebsite;
    type td_ConnectedWebsites = td_connectedWebsites;
    type td_ChatReportReason = td_chatReportReasonSpam | td_chatReportReasonViolence | td_chatReportReasonPornography | td_chatReportReasonChildAbuse | td_chatReportReasonCopyright | td_chatReportReasonUnrelatedLocation | td_chatReportReasonFake | td_chatReportReasonCustom;
    type td_InternalLinkType = td_internalLinkTypeActiveSessions | td_internalLinkTypeAuthenticationCode | td_internalLinkTypeBackground | td_internalLinkTypeBotStart | td_internalLinkTypeBotStartInGroup | td_internalLinkTypeChangePhoneNumber | td_internalLinkTypeChatInvite | td_internalLinkTypeFilterSettings | td_internalLinkTypeGame | td_internalLinkTypeLanguagePack | td_internalLinkTypeMessage | td_internalLinkTypeMessageDraft | td_internalLinkTypePassportDataRequest | td_internalLinkTypePhoneNumberConfirmation | td_internalLinkTypeProxy | td_internalLinkTypePublicChat | td_internalLinkTypeQrCodeAuthentication | td_internalLinkTypeSettings | td_internalLinkTypeStickerSet | td_internalLinkTypeTheme | td_internalLinkTypeThemeSettings | td_internalLinkTypeUnknownDeepLink | td_internalLinkTypeVoiceChat;
    type td_MessageLink = td_messageLink;
    type td_MessageLinkInfo = td_messageLinkInfo;
    type td_FilePart = td_filePart;
    type td_FileType = td_fileTypeNone | td_fileTypeAnimation | td_fileTypeAudio | td_fileTypeDocument | td_fileTypePhoto | td_fileTypeProfilePhoto | td_fileTypeSecret | td_fileTypeSecretThumbnail | td_fileTypeSecure | td_fileTypeSticker | td_fileTypeThumbnail | td_fileTypeUnknown | td_fileTypeVideo | td_fileTypeVideoNote | td_fileTypeVoiceNote | td_fileTypeWallpaper;
    type td_StorageStatisticsByFileType = td_storageStatisticsByFileType;
    type td_StorageStatisticsByChat = td_storageStatisticsByChat;
    type td_StorageStatistics = td_storageStatistics;
    type td_StorageStatisticsFast = td_storageStatisticsFast;
    type td_DatabaseStatistics = td_databaseStatistics;
    type td_NetworkType = td_networkTypeNone | td_networkTypeMobile | td_networkTypeMobileRoaming | td_networkTypeWiFi | td_networkTypeOther;
    type td_NetworkStatisticsEntry = td_networkStatisticsEntryFile | td_networkStatisticsEntryCall;
    type td_NetworkStatistics = td_networkStatistics;
    type td_AutoDownloadSettings = td_autoDownloadSettings;
    type td_AutoDownloadSettingsPresets = td_autoDownloadSettingsPresets;
    type td_ConnectionState = td_connectionStateWaitingForNetwork | td_connectionStateConnectingToProxy | td_connectionStateConnecting | td_connectionStateUpdating | td_connectionStateReady;
    type td_TopChatCategory = td_topChatCategoryUsers | td_topChatCategoryBots | td_topChatCategoryGroups | td_topChatCategoryChannels | td_topChatCategoryInlineBots | td_topChatCategoryCalls | td_topChatCategoryForwardChats;
    type td_TMeUrlType = td_tMeUrlTypeUser | td_tMeUrlTypeSupergroup | td_tMeUrlTypeChatInvite | td_tMeUrlTypeStickerSet;
    type td_TMeUrl = td_tMeUrl;
    type td_TMeUrls = td_tMeUrls;
    type td_SuggestedAction = td_suggestedActionEnableArchiveAndMuteNewChats | td_suggestedActionCheckPassword | td_suggestedActionCheckPhoneNumber | td_suggestedActionSeeTicksHint | td_suggestedActionConvertToBroadcastGroup;
    type td_Count = td_count;
    type td_Text = td_text;
    type td_Seconds = td_seconds;
    type td_DeepLinkInfo = td_deepLinkInfo;
    type td_TextParseMode = td_textParseModeMarkdown | td_textParseModeHTML;
    type td_ProxyType = td_proxyTypeSocks5 | td_proxyTypeHttp | td_proxyTypeMtproto;
    type td_Proxy = td_proxy;
    type td_Proxies = td_proxies;
    type td_InputSticker = td_inputStickerStatic | td_inputStickerAnimated;
    type td_DateRange = td_dateRange;
    type td_StatisticalValue = td_statisticalValue;
    type td_StatisticalGraph = td_statisticalGraphData | td_statisticalGraphAsync | td_statisticalGraphError;
    type td_ChatStatisticsMessageInteractionInfo = td_chatStatisticsMessageInteractionInfo;
    type td_ChatStatisticsMessageSenderInfo = td_chatStatisticsMessageSenderInfo;
    type td_ChatStatisticsAdministratorActionsInfo = td_chatStatisticsAdministratorActionsInfo;
    type td_ChatStatisticsInviterInfo = td_chatStatisticsInviterInfo;
    type td_ChatStatistics = td_chatStatisticsSupergroup | td_chatStatisticsChannel;
    type td_MessageStatistics = td_messageStatistics;
    type td_Point = td_point;
    type td_VectorPathCommand = td_vectorPathCommandLine | td_vectorPathCommandCubicBezierCurve;
    type td_BotCommandScope = td_botCommandScopeDefault | td_botCommandScopeAllPrivateChats | td_botCommandScopeAllGroupChats | td_botCommandScopeAllChatAdministrators | td_botCommandScopeChat | td_botCommandScopeChatAdministrators | td_botCommandScopeChatMember;
    type td_Update = td_updateAuthorizationState | td_updateNewMessage | td_updateMessageSendAcknowledged | td_updateMessageSendSucceeded | td_updateMessageSendFailed | td_updateMessageContent | td_updateMessageEdited | td_updateMessageIsPinned | td_updateMessageInteractionInfo | td_updateMessageContentOpened | td_updateMessageMentionRead | td_updateMessageLiveLocationViewed | td_updateNewChat | td_updateChatTitle | td_updateChatPhoto | td_updateChatPermissions | td_updateChatLastMessage | td_updateChatPosition | td_updateChatIsMarkedAsUnread | td_updateChatIsBlocked | td_updateChatHasScheduledMessages | td_updateChatVoiceChat | td_updateChatDefaultDisableNotification | td_updateChatReadInbox | td_updateChatReadOutbox | td_updateChatUnreadMentionCount | td_updateChatNotificationSettings | td_updateScopeNotificationSettings | td_updateChatMessageTtlSetting | td_updateChatActionBar | td_updateChatTheme | td_updateChatReplyMarkup | td_updateChatDraftMessage | td_updateChatFilters | td_updateChatOnlineMemberCount | td_updateNotification | td_updateNotificationGroup | td_updateActiveNotifications | td_updateHavePendingNotifications | td_updateDeleteMessages | td_updateUserChatAction | td_updateUserStatus | td_updateUser | td_updateBasicGroup | td_updateSupergroup | td_updateSecretChat | td_updateUserFullInfo | td_updateBasicGroupFullInfo | td_updateSupergroupFullInfo | td_updateServiceNotification | td_updateFile | td_updateFileGenerationStart | td_updateFileGenerationStop | td_updateCall | td_updateGroupCall | td_updateGroupCallParticipant | td_updateNewCallSignalingData | td_updateUserPrivacySettingRules | td_updateUnreadMessageCount | td_updateUnreadChatCount | td_updateOption | td_updateStickerSet | td_updateInstalledStickerSets | td_updateTrendingStickerSets | td_updateRecentStickers | td_updateFavoriteStickers | td_updateSavedAnimations | td_updateSelectedBackground | td_updateChatThemes | td_updateLanguagePackStrings | td_updateConnectionState | td_updateTermsOfService | td_updateUsersNearby | td_updateDiceEmojis | td_updateAnimatedEmojiMessageClicked | td_updateAnimationSearchParameters | td_updateSuggestedActions | td_updateNewInlineQuery | td_updateNewChosenInlineResult | td_updateNewCallbackQuery | td_updateNewInlineCallbackQuery | td_updateNewShippingQuery | td_updateNewPreCheckoutQuery | td_updateNewCustomEvent | td_updateNewCustomQuery | td_updatePoll | td_updatePollAnswer | td_updateChatMember;
    type td_Updates = td_updates;
    type td_LogStream = td_logStreamDefault | td_logStreamFile | td_logStreamEmpty;
    type td_LogVerbosityLevel = td_logVerbosityLevel;
    type td_LogTags = td_logTags;
    type td_TestInt = td_testInt;
    type td_TestString = td_testString;
    type td_TestBytes = td_testBytes;
    type td_TestVectorInt = td_testVectorInt;
    type td_TestVectorIntObject = td_testVectorIntObject;
    type td_TestVectorString = td_testVectorString;
    type td_TestVectorStringObject = td_testVectorStringObject;
